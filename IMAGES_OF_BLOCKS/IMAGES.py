...
from GLOBAL.GLOB import IMAGES_OF_BLOCKS, IMAGES_OF_BANGS, IMAGE_OF_BLUE_TANK, IMAGE_OF_RED_TANK, IMAGE_OF_INTRO_TANK, \
	CURSOR


"""
вызывается в draw_intro
отображает все картинки, используемые в игры по описанию строения, функция очень схожа с rules()			
"""
