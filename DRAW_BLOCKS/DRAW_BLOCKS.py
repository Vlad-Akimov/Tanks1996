...
from GLOBAL.GLOB import IMAGE_OF_BLUE_TANK, IMAGE_OF_RED_TANK, WIDTH, HEIGHT, TILE
from BLOCKS.BLOCKS import BlockBrick, BlockWater, BlockArmor, BlockBushes

"""
вызывается в draw_blocks(), 
создаёт: синий танк; красный танк; 20 блоков: воды, брони; 50 блоков кирпича; 30 блоков кустов
"""
