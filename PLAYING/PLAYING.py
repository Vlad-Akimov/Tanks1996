...
цикл процесса игры,
	с вызовом определённых методов,
...
def game(
	...
	while play:
		...
		if not paused:
			...
			создание одного списка объектов,
				вместо двух
			
				для более правильной отрисовки объектов
				
			таким образом:
				
				сначала отображаются танки и вода,
					потом снаряды,
					после этого, оставшееся
			
			это необходимо для того, 
				чтобы снаряды проходили "над" танками и водой,
			...
			list_1 = list_of_objects[
			         :2
			         ]

			list_2 = list_of_objects[
			         2:
			         21
			         ]
